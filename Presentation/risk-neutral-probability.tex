...
\begin{frame}{State Densities Through Time}
  \begin{figure}\centering 
        ...
        \vspace{-6ex}
        \begin{flushleft}
            \tiny \textit{Notes:} This figure shows the 5th- 95th percentile interval (in light gray) and 25th-75th percentile interval (in dark gray) of the estimated implied risk neutral density around the liberation date 2025-04-02 (red vertical line).
        \end{flushleft}
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}{Concentration Parameter Posteriors}
  \begin{figure}\centering 
        \begin{minipage}{0.94\linewidth}\centering
            ...
            \vspace{-6ex}
        \begin{flushleft}
            \tiny \textit{Notes:} This figure shows the posterior mean and HPD interval (in gray) of the concentration parameter of the Dirichlet distribution, $\alpha$, around the liberation day, 2025-04-02. 
        \end{flushleft}
        \end{minipage}
    \end{figure}
\end{frame}
